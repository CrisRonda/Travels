const back1 = require('src/assets/001.jpg');
const back2 = require('src/assets/002.jpg');
const screen1 = require('src/assets/bg01.jpg');
const screen2 = require('src/assets/bg02.jpg');
const screen3 = require('src/assets/bg03.jpg');
const dt1 = require('src/assets/dt1.jpg');
const dt2 = require('src/assets/dt2.jpg');
const dt3 = require('src/assets/dt3.jpg');
...
const backgroundImage = [back1, back2];
